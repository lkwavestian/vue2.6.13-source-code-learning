...
class StringNode {
  ...
  constructor(open: string, close?: string, children?: Array<any>, normalizationType?: number) {
    this.isString = true;
    this.open = open;
    this.close = close;
    if (children) {
...
function renderSSRStyle(staticStyle: ?Object, dynamic: any, extra: ?Object): string {
  const style = {};
