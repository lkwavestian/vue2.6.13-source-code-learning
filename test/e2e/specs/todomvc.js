module.exports = {
  todomvc: function (browser) {
    ...
    createNewItem("test4");
    createNewItem("test5").assert.count(".todo", 5).assert.containsText(".todo-count strong", "4");
    ...
    createNewItem("test");
    createNewItem("test").click(".todo:nth-child(2) .toggle").click(".todo:nth-child(3) .toggle");
