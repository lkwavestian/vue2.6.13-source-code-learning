...
describe("compile basic", () => {
  ...
  it("should compile data bindings with children", () => {
    ...
    expect(render).toEqual(
      `with(this){return _c('foo',{attrs:{"a":b}},[_c('text',[_v("Hello")])])}`
    );
    expect(staticRenderFns).toEqual([]);
    expect(errors).toEqual([]);
  });
  ...
  it("should compile unary tag", () => {
    ...
    expect(inputCase.staticRenderFns).toMatch(
      strToRegExp(`_c('div',[_c('input'),_c('text',[_v("abc")])])`)
    );
    ...
    expect(imageCase.staticRenderFns).toMatch(
      strToRegExp(`_c('div',[_c('image',{attrs:{"src":"path"}}),_c('text',[_v("abc")])])`)
    );
    ...
    expect(complexCase.staticRenderFns).toMatch(
      strToRegExp(`_c('image',{attrs:{"src":"path"}}),_c('image'),_c('div'`)
    );
    expect(complexCase.staticRenderFns).toMatch(
      strToRegExp(
        `_c('div',[_c('embed'),_c('text',[_v("start")]),_c('input',{attrs:{"type":"text"}}),_c('input',{attrs:{"type":"url"}}),_c('text',[_v("end")])]`
      )
    );
  ...
  it("should compile more complex situation", () => {
    ...
    `);
    expect(render).toEqual(
      `with(this){return _c('refresh',{staticClass:["refresh"],staticStyle:{flexDirection:"row"},attrs:{"display":displayRefresh},on:{"refresh":handleRefresh}},[_c('loading-indicator'),_c('text',{staticStyle:{marginLeft:"36px",color:"#eee"}},[_v("Load more...")])])}`
    );
    expect(staticRenderFns).toEqual([]);
    expect(errors).toEqual([]);
  });
